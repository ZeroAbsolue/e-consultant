...
<header id="home">
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark ">
        ...
        <div class="collapse navbar-collapse" id="basicExampleNav">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="" data-toggle="modal" data-target="#modalLRForm"><i class="rounded-circle avatar-img z-depth-1-half fa fa-user-circle"></i>My Account</a>
                </li>
            </ul>
        </div>
        <!-- Collapsible content -->
    ...
    <!--/.Navbar-->
        ...
        <!-- Card image -->
    <div id="carousel-thumb" class="carousel slide carousel-fade carousel-thumbnails mt-5" data-ride="carousel">
...
<main>
    ...
    <div class="container">
        ...
        <section id="about" class="section pt-3 pb-5 mb-5">
            ...
            <!--Secion heading-->
            <h2 class="indigo-text text-center text-uppercase font-weight-bold mt-4 mb-5 py-5 wow fadeIn" data-wow-delay="0.2s">About us</h2>
            ...
            <div class="row wow fadeIn" data-wow-delay="0.2s">
                ...
                <div class="col-lg-4 mb-2">
                    <div class="view"> <img src="/img/5057b96d9ee9123.jpg" class="img-fluid z-depth-1" alt="">
                        <div class="  rgba-indigo-strong smooth-scroll flex-center">
        ...
        <div class="flex-center rgba-indigo-light mask">
            <div class="white-text smooth-scroll mx-4">
                ...
                <div class="text-center">
                    ...
                    <a href="" class="btn btn-outline-white wow fadeIn " data-toggle="modal" data-target="#modalLRForm" data-offset="100" data-wow-delay="0.2s">Sign In</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <!--Section: About-->
        <section id="services" class="section  pt-3 pb-5 mb-5">
    ...
    <div class="container">
    <!--Section: Contact-->
    <section id="contact" class="section pt-3 pb-5 mb-5">
        ...
        <div class="row mt-2">
            ...
            <div class="col-xl-4 col-lg-4 pb-1 wow fadeIn" data-wow-delay="0.3s">
                ...
                <div class="footer-socials">
                    ...
                    <!--Facebook-->
                    <a type="button" class="btn-floating btn-primary"><i class="fa fa-facebook"></i></a>
                    <!--Dribbble-->
                    <a type="button" class="btn-floating btn-primary"><i class="fa fa-dribbble"></i></a>
                    <!--Twitter-->
                    <a type="button" class="btn-floating btn-primary"><i class="fa fa-twitter"></i></a>
                    <!--Google +-->
                    <a type="button" class="btn-floating btn-primary"><i class="fa fa-google-plus"></i></a>
                    <!--Linkedin-->
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 pt-1 pb-1">
                ...
                <!--Opening hours table-->
                <table class="table wow fadeIn" data-wow-delay="0.3s">
                    <tbody>
                    <tr>
                        <td>Mon - Thu:</td>
                        <td>8am - 9pm</td>
...
<div class="dotted-scrollspy clearfix d-none d-sm-block">
    <ul class="nav smooth-scroll flex-column">
        ...
        <li class="nav-item"><a class="nav-link" href="#testimonials"><span></span></a></li>
        <li class="nav-item"><a class="nav-link" href="#projet"><span></span></a></li>
...
{{--<div class="container">--}}
    {{--<div class="row mt-4 mb-3" style="height: 40px;">--}}
        {{--<div class="col-md-3 col-lg-3 view overlay" style="position: relative; top: -55px;" >--}}
            {{--<img src="/img/mdb.jpg" alt="logo mdb" class="img-fluid">--}}
        {{--</div>--}}
        {{--<div class="col-md-3 col-lg-3" >--}}
            {{--<button class="btn btn-amber btn-circle-2 waves-effect ml-0" data-toggle="tooltip" title="Basic Information">--}}
                {{--<i class="fa fa-home"></i>--}}
            {{--</button>--}}
            {{--<div style="position: relative; top:-50%; left: 30%">--}}
                {{--<p class="indigo-text">3001, Logbessou </p>--}}
                {{--<p class="grey-text">Douala, Cameroun</p>--}}
            {{--</div>--}}
        ...
        {{--<div class="col-md-3 col-lg-3" >--}}
            ...
            {{--</button>--}}
            {{--<div style="position: relative; top:-50%; left: 30%">--}}
                {{--<p class="indigo-text">Call Us  On</p>--}}
                {{--<p class="grey-text">237 6-70-37-12-36</p>--}}
            {{--</div>--}}
        {{--</div>--}}
        {{--<div class="col-md-3 col-lg-3" >--}}
            {{--<button class="btn btn-amber btn-circle-2 waves-effect ml-0" data-toggle="tooltip" title="Basic Information">--}}
            ...
            {{--</button>--}}
            {{--<div style="position: relative; top:-50%; left: 30%">--}}
                {{--<p class="indigo-text">Mail Us @</p>--}}
                {{--<p class="grey-text">support@eBusy.com</p>--}}
            {{--</div>--}}
        {{--</div>--}}
    {{--</div>--}}
{{--</div>--}}
